  	...
  	computed: {
  		...
  		latentsBytes: {
  			get () {
  				...
  				return encodeURIComponent(encodeFloat32(this.featureVector));
  			},
  		...
  		latentsBytesEx: {
  			get () {
  				...
  				return encodeURIComponent(encodeFixed16(this.featureVectorEx));
  			},
